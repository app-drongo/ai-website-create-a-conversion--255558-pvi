...
export default function Cta() {
  const stats = [
    { value: "200+", label: "Apps Built", icon: Zap },
    { value: "98%", label: "Client Satisfaction", icon: Shield },
    { value: "7 Days", label: "Avg. Delivery", icon: Sparkles },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="inline-flex items-center px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-sm font-medium text-primary mb-8">
                ...
                Launch Special - 50% Off Discovery Call
              </div>
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Stop waiting for the "perfect time" to build your app. Join 200+ entrepreneurs 
                who chose NoCodeNinja to bring their vision to life without code or complexity.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Most apps delivered within 7-14 days
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">No-Code Expertise</h3>
              <p className="text-sm text-muted-foreground">
                Certified experts in all major no-code platforms
              </p>
            </div>
          </div>
        </div>
